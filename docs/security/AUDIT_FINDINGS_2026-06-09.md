...
- **L-18** — `docs/architecture/SQUARE_POS_INTEGRATION.md` does not exist in this worktree (referenced by the Square work). Document the integration + the go-live checklist. Confidence HIGH.
